...
#               cd /var/www/html
#               sudo chown ec2-user .
#               git clone https://$github_token@github.com/zavfake/restart-2025-idjak141-devops.git
#               rm -f ./index.html
#               cp /var/www/html/restart-2025-idjak141-devops/hello.html /var/www/html/index.html
#               sudo rm -rf restart-2025-idjak141-devops
#               EOF
# }
